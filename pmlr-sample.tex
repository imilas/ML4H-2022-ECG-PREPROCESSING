...
\floatconts
  {tab:sr_corr}
  {\caption{Pearson correlation between sampling rate and performance, and sampling and MRR. The correlations are measured for each model as well as the combined results of all models. When the results for all models across all datasets are concatenated, the correlation value is 0.038 for the performance measure (F1) and 0.039 for MRR. }}
  {\begin{tabular}{|l|l|l|}
  \hline
   & \bfseries F1  & \bfseries MRR \\\hline
  
  Inception  & -0.055 & -0.228  \\
  MiniRocket &  0.026 & 0.170  \\
  xresnet    & 0.054 & 0.249  \\
  \hline
  All Models & 0.038 & 0.039\\
  \hline
  \end{tabular}}
\end{table}
...
% \begin{table}[]
% \begin{tabular}{lllll}
%           & CPSC    & Chapman & PTBXL    & All Datasets \\
% Inception  & -0.154  & -0.0355 & -0.00280 & -0.0547      \\
% Minirocket & 0.017   & 0.010   & 0.0528   & 0.0262       \\
% xresnet    & -0.0925 & 0.0833  & 0.111    & 0.0536       \\
% All Models & 0.148   & -0.070  & -0.217   & 0.0393      
% \end{tabular}
% \caption{}
